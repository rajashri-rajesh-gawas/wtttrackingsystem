...
<div class="col-md-offset-6">
    <a class="btn btn-primary btn-md" href="<?php echo Url::toRoute('tblemployee-attendance/index');?>">View Employee Details</a>
</div>
<div class="tblemployee-attendance-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'emp_id')->dropDownList($employeelist,['prompt'=>'Choose...']) ?>
